...
then
    ...
    cd ${ROCKETMQ_HOME} && echo "listenPort=${port}" >> conf/2m-2s-sync/broker-a.properties
...
then
    ...
    cd ${ROCKETMQ_HOME} && echo "listenPort=${port}" >> conf/2m-2s-sync/broker-a-s.properties
...
then
    ...
    cd ${ROCKETMQ_HOME} && echo "listenPort=${port}" >> conf/2m-2s-sync/broker-b.properties
...
then
    ...
    cd ${ROCKETMQ_HOME} && echo "listenPort=${port}" >> conf/2m-2s-sync/broker-b-s.properties
